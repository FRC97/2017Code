...
/**
* GripPipelineAndOutput class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class GripPipelineAndOutput {
	...
	static double[] hslThresholdHue = {78, 92};
	static double[] hslThresholdSaturation = {172, 255};
	static double[] hslThresholdLuminance = {44, 255.0};
	
	static double thresh = 10;
	static double threshRatio = 3;
	...
	public static void process(Mat source0) {
		...
		Mat blurOutput = hslThresholdOutput;
		Imgproc.blur(hslThresholdOutput, blurOutput, new Size(kBlur,kBlur));
		
		Mat cannyOutput = blurOutput;
		Imgproc.Canny(blurOutput, cannyOutput, thresh, thresh*threshRatio);
		
		// Step Find_Contours0:
		Mat findContoursInput = cannyOutput;//hslThresholdOutput;
